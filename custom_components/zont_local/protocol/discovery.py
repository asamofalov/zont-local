...
from .session import ZontTemporaryRequestSession
...
async def async_discover_objects_from_requests(
    requests: ZontTemporaryRequestSession,
) -> MappingProxyType[int, ZontObject]:
    """Discover parseable objects through an authenticated connection."""
